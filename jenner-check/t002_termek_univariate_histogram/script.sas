/* Adapted from adatgeneralas.sas (TERMEK block) + feladat_megoldasok.sas (feladat 2).
   ...
   reproduces the student's PROC UNIVARIATE + HISTOGRAM step used to check
   whether the generated width/length/area figures follow a normal
   distribution. */
